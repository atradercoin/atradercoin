...
Copyright (c) 2017 ATRADER Developers
...
Intro
-----
ATRADERCOIN is a free open source peer-to-peer electronic cash system that is
...
If you have Microsoft Security Essentials, you need to add atradercoin-qt.exe to its
