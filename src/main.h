...
static const int64 MIN_TX_FEE = THOU;       // Min atradercoin fee 0.001TC
static const int64 MIN_RELAY_TX_FEE = MIN_TX_FEE;
static const int64 MAX_MONEY = 75000000 * COIN; // maximum of 75 000 000 coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 5760 / 250; // 5760 blocks found a day. Priority cutoff is 1 ATC day / 250 bytes.
    }
    ...
    int64 GetMinFee(unsigned int nBlockSize=1, bool fAllowFree=true, enum GetMinFee_mode mode=GMF_BLOCK) const
    {
        ...
        if (!MoneyRange(nMinFee))
            nMinFee = MAX_MONEY;
        if (fDebug)
            printf("GetMinFee returned %ld ", nMinFee);
        return nMinFee;
    }
